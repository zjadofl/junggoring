...
<header class="p-3 mb-3 border-bottom">
	<div class="container">
		<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
			<a href="home.do" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none"> 
				<span id="logo">중고링</span>
			</a>
			<ul class="nav nav-menu col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 align-middle">
				<li><a href="noticeSelectAll.do" class="nav-link px-3">공지사항</a></li>
				<li><a href="boardSelectAll.do" class="nav-link px-3">중고거래</a></li>
				<li><a href="roomSelectAll.do" class="nav-link px-3">채팅목록</a></li>
			</ul>

			<form action="b_searchList.do" class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" role="search">
				<input type="search" name="searchWord" id="searchWord" class="form-control" placeholder="제목 또는 내용 입력" aria-label="Search">
			</form>

			<div>
				<ul class="nav">
					<li><a id="login" href="login.do" class="nav-link px-2">로그인</a></li>
					<li><a id="memberInsert" href="memberInsert.do" class="nav-link px-2">회원가입</a></li>
				</ul>
			</div>

			<div class="dropdown text-end">
				<a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> ${name}님 </a>
